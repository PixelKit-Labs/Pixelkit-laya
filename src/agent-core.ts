...
// PixelKit Labs separated the shared decision engine from platform artifact loading.
import {
  TEMP_MAX,
  TEMP_MIN,
  buildQuestionPrefix,
...
export function tokenizerFromHF(tokenizerJson: unknown): TokenizerLike | null {
...
export class Agent extends HookRegistry {
  ...
  /** Release native sessions when the host app no longer needs this model. */
